...
public class LivreCompletDto {
	...
	@Schema(description="Auteur qui a écrit le livre on le mappe avec le dto de la classe auteur" , exampleClasses = AuteurDto.class)
	private Auteur auteur;
	@Schema(description="Categorie qui décrit dans quelle style d'écriture le livre se retrouve, on le mappe avec le dto de la classe" ,  exampleClasses = CategorieDto.class)
