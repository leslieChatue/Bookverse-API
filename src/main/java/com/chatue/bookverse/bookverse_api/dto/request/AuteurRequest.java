...
public class AuteurRequest {
	 ...
	 @NotBlank(message="Vous devez obligatoirement saisir une biographie!")
	 @Size(min=2 , max=200, message="Vous devez obligatoirement saisir un biographie de plus de 2 caractères!")
